...
ernie_path="pretrain_language_models/ernie-health-zh"
longformer_path="pretrain_language_models/Erlangshen-Longformer-110M"

echo "****** hyperparameters *******"
echo "enc_name: MultiViewModel"
...
for seed in 0 1 2 3; do
     python main.py --model_name MultiViewModel --gpu $gpu --bert_path $longformer_path \
                ...
                > result/logs/MultiViewModelLongformer_seed${seed}_${dt}.log
done
